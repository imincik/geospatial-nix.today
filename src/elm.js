...
var $author$project$HomePage$allPackages = _List_fromArray(
	['geopkgs.gdal', 'geopkgs.gdal-minimal', 'geopkgs.pdal', 'geopkgs.grass', 'geopkgs.qgis', 'geopkgs.qgis-ltr', 'pkgs.sl']);
var $author$project$HomePage$allPgPackages = _List_fromArray(
	['geopkgs.postgresql-postgis', 'pkgs.postgresqlPackages.pgrouting']);
var $author$project$HomePage$allPyPackages = _List_fromArray(
...
var $author$project$HomePage$buildConfig = function (model) {
	return A3(
		...
		A3(
			$elm$core$String$replace,
			'<PG-PACKAGES>',
			A2($elm$core$String$join, ' ', model.selectedPgPackages),
			A3(
				$elm$core$String$replace,
				'<POSTGRES-ENABLED>',
				...
				A3(
					$elm$core$String$replace,
					'<PY-PACKAGES>',
					A2($elm$core$String$join, ' ', model.selectedPyPackages),
					A3(
						$elm$core$String$replace,
						'<PYTHON-ENABLED>',
						model.pythonEnabled,
						A3(
							$elm$core$String$replace,
							'<PACKAGES>',
							A2($elm$core$String$join, ' ', model.selectedPackages),
...
var $author$project$HomePage$toHtmlListAdd = F3(
	function (availableItems, selectedItems, onClickAction) {
		return A2(
			$elm$html$Html$ul,
			_List_fromArray(
				[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('name d-flex justify-content-between align-items-center')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										...
										A3($author$project$HomePage$toHtmlListAdd, model.availablePackages, model.selectedPackages, $author$project$HomePage$AddPackage),
										A2($elm$html$Html$hr, _List_Nil, _List_Nil)
									])),
								A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										A3($author$project$HomePage$toHtmlListAdd, model.availablePyPackages, model.selectedPyPackages, $author$project$HomePage$AddPyPackage),
										A2($elm$html$Html$hr, _List_Nil, _List_Nil)
									])),
								A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										A3($author$project$HomePage$toHtmlListAdd, model.availablePgPackages, model.selectedPgPackages, $author$project$HomePage$AddPgPackage),
										A2($elm$html$Html$hr, _List_Nil, _List_Nil)
									])),
								A2(
								$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('configuration')
									]),
								_List_fromArray(
									[
										A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$href('https://nix.dev'),
														$elm$html$Html$Attributes$target('_blank')
													]),
												_List_fromArray(
													[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('https://github.com/imincik'),
												$elm$html$Html$Attributes$target('_blank')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Ivan Mincik, @imincik')
											])),
										$elm$html$Html$text('.')
									]))
							]))
